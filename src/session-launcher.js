...
// Server-side directory browser for the launcher's "Browse" button, since
// a browser file picker can't expose real filesystem paths. NOT token-
// gated (no session exists pre-launch) - protected only by the Origin/
// Host spoof check, which deliberately allows a missing Origin (curl).
// Low severity for a local dev tool, but don't overstate the protection.
